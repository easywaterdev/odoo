...
class ProviderUPS(models.Model):
    ...
    def ups_get_return_label(self, picking, tracking_number=None, origin_date=None):
        ...
        if picking.write_uid.employee_id and picking.write_uid.employee_id.use_address_for_returns and picking.write_uid.private_street and picking.write_uid.private_city and picking.write_uid.private_state_id and picking.write_uid.private_zip and picking.write_uid.private_country_id:
            srm.send_shipping(
