...
class Contact(models.Model):
    ...
    x_studio_original_confirmation_date = fields.Char('Original Confirmation Date', store=True)
    ...
    def _query(self, with_clause='', fields={}, groupby='', from_clause=''):
        ...
        select_ = """
            ...
            s.id as order_id,
			s.x_studio_original_confirmation_date as x_studio_original_confirmation_date
        """
