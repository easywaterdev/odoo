        ...
        for mail_id in self.ids:
            ...
            try:
                ...
                mail.write(
                    {
                        ...
                        "failure_reason": _(
                            ...
                            "Probably due do sending an email "
                            "without computed recipients."
                        ),
                    }
                )
                # Update notification in a transient
                # exception state to avoid concurrent
                # update in case an email bounces
                # while sending all emails related to current
                # mail record.
                ...
                if notifs:
                    notif_msg = _(
                        "Error without exception. "
                        "Probably due do concurrent "
                        "access update of notification records. "
                    ...
                    # force immediate update to obtain the lock.
                ...
                # build an RFC2822 email.message.
                # Message object and send it without queuing
                res = None
                # TDE note: could be great to
                # pre-detect missing to/cc and skip sending it
                ...
                if res:  # mail has been sent at least once, no major exception occurred
                    ...
                    # /!\ can't use mail.state here,
                    # as mail.refresh() will cause an error
                ...
                # mail status will stay on ongoing
                # since transaction will be rollback
                raise
            except (psycopg2.Error, smtplib.SMTPServerDisconnected):
                # If an error with the database or SMTP
                # session occurs, chances are that the cursor
                # or SMTP session are unusable, causing
                # further errors when trying to save the state.
                _logger.exception(
