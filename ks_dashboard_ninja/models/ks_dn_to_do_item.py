    ...
    def _ksGetToDOData(self):
        ...
        if self.ks_dn_header_lines:
            for ks_dn_header_line in self.ks_dn_header_lines:
                ...
                # if type(ks_dn_header_line.id).__name__ != 'int' and ks_dn_header_line.id.origin != None:
                #     ks_dn_header_line_id = str(ks_dn_header_line.id.origin)
                if ' ' in  ks_dn_header_line.ks_to_do_header:
                    ks_temp = ks_dn_header_line.ks_to_do_header.replace(" ", "_")
                    ks_to_do_data['ks_link'].append('#' + ks_temp + str(ks_dn_header_line.id))
                    ks_to_do_data['ks_href_id'].append(ks_temp + ks_dn_header_line_id)
                    ...
                    ks_to_do_data['ks_link'].append('#' + ks_dn_header_line.ks_to_do_header + str(ks_dn_header_line.id))
                    ks_to_do_data['ks_href_id'].append(ks_dn_header_line.ks_to_do_header + ks_dn_header_line_id)
