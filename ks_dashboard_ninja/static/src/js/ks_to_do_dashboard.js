...
//        'click .ks_add_section': '_onKsAddSection',
        ...
        'click .ks_li_tab': 'ks_preventDefault',
    }),
            ...
            var ks_container_class = 'grid-stack-item',
                ...
                if (self.grid) {
                    ...
                    if (items[i].ks_dashboard_item_type === 'ks_tile') {
                        ...
                        if (items[i].id in self.gridstackConfig) {
                            self.grid.addWidget($to_do_preview, self.gridstackConfig[items[i].id].x, self.gridstackConfig[items[i].id].y, self.gridstackConfig[items[i].id].width, self.gridstackConfig[items[i].id].height, false, 11, null, 3, null, items[i].id);
                        } else {
                            self.grid.addWidget($to_do_preview, 0, 0, 13, 4, true, 11, null, 3, null, items[i].id)
                        }
                    } else {
