...
var KSFIELD_OPERATORS = {

        date: [
            { symbol: "=", description: _t("is equal to") },
            { symbol: "!=", description: _t("is not equal to") },
            { symbol: ">", description: _t("is after") },
            { symbol: "<", description: _t("is before") },
            { symbol: ">=", description: _t("is after or equal to") },
            { symbol: "<=", description: _t("is before or equal to") },
            { symbol: "between", description: _t("is between") },
            { symbol: "!=", description: _t("is set"), value: false },
            { symbol: "=", description: _t("is not set"), value: false },
        ],
        datetime: [
            { symbol: "between", description: _t("is between") },
            { symbol: "=", description: _t("is equal to") },
        ...
        id: [
            { symbol: "=", description: _t("is") },
        ],
        number: [
            { symbol: "=", description: _t("is equal to") },
            { symbol: "!=", description: _t("is not equal to") },
            { symbol: ">", description: _t("greater than") },
            { symbol: "<", description: _t("less than") },
            { symbol: ">=", description: _t("greater than or equal to") },
            { symbol: "<=", description: _t("less than or equal to") },
            { symbol: "!=", description: _t("is set"), value: false },
            { symbol: "=", description: _t("is not set"), value: false },
        ],
        selection: [
            { symbol: "=", description: _t("is") },
            { symbol: "!=", description: _t("is not") },
            { symbol: "!=", description: _t("is set"), value: false },
            { symbol: "=", description: _t("is not set"), value: false },
        ],
        boolean: [
            { symbol: "=", description: _t("is true"), value: true },
            { symbol: "!=", description: _t("is false"), value: true },
        ],
        char: [
            { symbol: "ilike", description: _t("contains") },
            { symbol: "not ilike", description: _t("doesn't contain") },
            { symbol: "=", description: _t("is equal to") },
            { symbol: "!=", description: _t("is not equal to") },
            { symbol: "!=", description: _t("is set"), value: false },
            { symbol: "=", description: _t("is not set"), value: false },
...
return KsFilterProps.include({
    ...
    init: function(){
        ...
        this.ksCustomFilterData = {
            OPERATORS : KSFIELD_OPERATORS,
            KSFIELD_TYPES : KSFIELD_TYPES,
            DECIMAL_POINT : 2,
        }
    },
    ...
    ks_render_custom_filter: function(show_remove_option){
        ...
        var operators = this.ksCustomFilterData.OPERATORS[this.ksCustomFilterData.KSFIELD_TYPES[field_type]];
        ...
        var $value_input = this._ksRenderCustomFilterInputSection(operator_type, this.ksCustomFilterData.KSFIELD_TYPES[field_type], first_field_select.special_data)
    ...
    ksOnCustomFilterFieldSelect: function(ev){
        ...
        var $value_input = this._ksRenderCustomFilterInputSection(operator_type, this.ksCustomFilterData.KSFIELD_TYPES[field_type], field_select.special_data)
    ...
    ksOnCustomFilterOperatorSelect: function(ev){
        ...
        var field_select = this.ks_dashboard_data.ks_dashboard_custom_domain_filter[field_id];
        var field_type = field_select.field_type;
        var operator_type = this.ksCustomFilterData.OPERATORS[this.ksCustomFilterData.KSFIELD_TYPES[field_type]][ev.currentTarget.selectedIndex];
    ...
    ksOnCustomFilterApply: function(){
        ...
        $('.ks_dn_custom_filter_input_container_section').each((index, filter_container) => {
            ...
            var domainValue = [];
            var domainArray = [];
            var operator = this.ksCustomFilterData.OPERATORS[this.ksCustomFilterData.KSFIELD_TYPES[field_type]][$(filter_container).find('.ks_operator_option_selector').prop('selectedIndex')];
